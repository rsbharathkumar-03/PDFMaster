...
export const ToolView: React.FC<ToolViewProps> = ({
  ...
  useEffect(() => {
    ...
    let applicationScript = document.getElementById(
  ...
  const handleProcess = async () => {
    ...
    if (
      ...
      !splitConfig.pageRanges.trim()
    ) {
      setErrorMsg(
        'Please enter a valid page range (e.g., "1-3, 5").'
      );
      return;
    }
    ...
    try {
      ...
      setErrorMsg(
        err.message ||
          'Unable to process document. Please check the file and try again.'
      );
    } finally {
    ...
    <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
      ...
      <div className="mb-6 flex items-center justify-between">
        ...
        <button
          ...
          aria-label={`Go back from ${tool.title}`}
        >
        ...
        {!result ? (
          <div>
            ...
            <FileUploader
              ...
              label={
                tool.multipleFiles
                  ...
                  : `Select ${tool.acceptedFormats} file`
              }
            ...
            {isProcessing && (
              <ProgressBar
                progress={progress}
                statusText={`Processing ${tool.title}...`}
              />
            )}
      ...
      >
        ...
        <h2
          id="tool-information-heading"
          className="text-2xl font-bold tracking-tight text-slate-900 sm:text-3xl mb-4"
        >
          {tool.h2}
        </h2>
